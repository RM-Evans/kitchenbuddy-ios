    ...
    return (
            ...
            <View testID="LoginScreen" style={FULL}>
                ...
                <View style={MENU_BUTTONS_CONTAINER}>
                    ...
                    <Button style={MENU_BUTTONS}><Text style={MENU_BUTTONS_TEXT}>PLAY</Text></Button>

                    <Button style={MENU_BUTTONS} onPress={goChooseDifficulty}><Text style={MENU_BUTTONS_TEXT}>CREATE GAME</Text></Button>

                    <Button style={HOW_TO_PLAY_MENU_BUTTON}><Text style={HOW_TO_PLAY_MENU_BUTTON_TEXT}>HOW TO PLAY</Text></Button>
                ...
                <Text 
                 ...
                 >
                 Already have an account?<Text style={SIGNUP_REDIRECT_LINK} onPress={goLogin}> Login </Text>
                </Text>
